    ...
    function(Callback, $http, Error, $ionicLoading) {
        ...
        Http._checkHttpResponse = function(data, config) {
            ...
            if (data.status === "SUCCESS") {
                ...
                if (config.onFail) config.onFail.fire(new Error(data.result || "Unkown error happened while connecting to server!", true, true), data.status, data.result);
            }
        };
        ...
        Http.Get = function(config) {
            ...
            config.params.token = "4534jg5438gj8ASJ383ajss8";
